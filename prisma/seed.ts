...
async function main() {
  ...
  const activitiesSchedule = [
    ...
    { id: 3, startsAt: dayjs().set('hour', 12).set('minute', 0).set('second', 0).toDate(), endsAt: dayjs().set('hour', 14).set('minute', 0).set('second', 0).toDate(), localId: 1 },
    ...
    { id: 5, startsAt: dayjs().set('hour', 11).set('minute', 0).set('second', 0).toDate(), endsAt: dayjs().set('hour', 12).set('minute', 0).set('second', 0).toDate(), localId: 2 },
    { id: 6, startsAt: dayjs().set('hour', 13).set('minute', 0).set('second', 0).toDate(), endsAt: dayjs().set('hour', 14).set('minute', 0).set('second', 0).toDate(), localId: 2 },
